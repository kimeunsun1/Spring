...
<body>
	<div class="w3-content mxw700">
		...
		<div class="w3-col w3-center w3-margin-bottom">
			<div class="w3-col">
				<div class="w3-third">
					<select class="w3-quarter w3-select w3-border" id="gn">
				...
				<div class="w3-third" style="padding-left: 5px;">
					<select class="w3-quarter w3-select w3-border" id="gen">
						<option disabled selected>::: 성별 선택 :::</option>
						<option value="남자" class="w3-text-blue">남자</option>
						<option value="여자" class="w3-text-blue">여자</option>
					</select>
				</div>
				<div class="w3-third" style="padding-left: 5px;">
					<select class="w3-quarter w3-select w3-border" id="style">
			...
			<div class="w3-col w3-margin-top">
				<div class="w3-half">
					<select class="w3-quarter w3-select w3-border" id="gselect">
